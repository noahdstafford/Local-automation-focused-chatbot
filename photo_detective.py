...
def run_photo_detective():
    # Input question and file for the system to check 
    checked_image = input('Give the file name of the image you want checked: ')
    ...
    print("\nLooking at the image, please wait...\n")
